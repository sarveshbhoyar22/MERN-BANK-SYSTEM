    ...
    <>
      <div>
        <footer className="footer sm:footer-horizontal text-base-content p-10 bg-black">
          ...
          <span className=" text-sm flex flex-col justify-center text-center bg-black">Copyright © 2025 - All right reserved </span>
          <span className=" text-sm flex flex-col justify-center text-center bg-black"> Sarvesh Bhoyar (IIT(ISM)Dhanbad)     </span>
      </div>
    </>
  );
}
