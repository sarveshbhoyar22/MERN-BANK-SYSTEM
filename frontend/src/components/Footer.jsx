          ...
          {user ? (
            <div>
              <ul className='grid grid-flow-row gap-4'>
                <li>📞 Customer Support – "Need help? Call 1800-000-0000"</li>
                <li>📍 Branch Locator – Find nearest bank branches</li>
                <li>🔒 Security Tips – "Never share your password or OTP"</li>
              </ul>
            </div>
          ) : (
            ""
