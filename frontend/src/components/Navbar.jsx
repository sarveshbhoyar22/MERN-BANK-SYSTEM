  ...
  return (
    <div className="navbar bg-black shadow-sm">
      ...
      <div className="navbar-center">
        <Link to="/Dashboard" role="button" draggable="false" className="btn btn-ghost normal-case text-2xl">
          NORWEGIAN-BANK
        </Link>
          ...
          >
            ...
            <li>
             <button onClick={logout}>{
                    loading ? <span className="loading loading-ring loading-6xl"></span> : "Logout"
